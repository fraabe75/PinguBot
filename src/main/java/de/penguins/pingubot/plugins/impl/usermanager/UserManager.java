package de.penguins.pingubot.plugins.impl.usermanager;
...
public class UserManager extends Plugin implements GuildMessageReceivedPlugin {
    ...
    public static MessageEmbed help() {
        ...
        builder.addField("send <@username> <amount>", "send fish to your friends", false);
    ...
    public static MessageEmbed helpLevel() {
        ...
        builder.setDescription("""
                ...
                As soon as you grew enough
                to become a Humboldt penguin (adult state),
    ...
    private String level(UserEntity user) {
        ...
        if (user.getRank().equals("dynamic")) {
            return "You are already an adult penguin, reach higher levels through a higher mateability!";
        }
