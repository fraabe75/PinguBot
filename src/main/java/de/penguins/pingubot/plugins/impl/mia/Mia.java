package de.penguins.pingubot.plugins.impl.mia;
...
public class Mia extends Plugin implements GuildMessageReceivedPlugin {
    ...
    public static MessageEmbed help() {
        ...
        builder.addField("mia play <bet-amount>", "start a new game", false);
        ...
        switch (param.trim().split(" ")[0]) {
            case "start", "play", "new", "game", "p" -> {
                ...
                while (running) {
                    ...
                    if (miaPlayer == 1) {
                        builder.addField("Player throw: " + totalRoll, "" + result, false);
                    } else {
            ...
            case "rules", "r" -> channel.sendMessage(new EmbedBuilder()
